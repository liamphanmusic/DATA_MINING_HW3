...
# Plotting Tree
CT_Tree_Plot <- prp(CT_Tree,type = 1, under = TRUE, split.font = 1, varlen = -10,box.col=ifelse(CT_Tree$frame$var == "<leaf>", 'gray', 'white'))
...
> By using the CT Tree, we first start with Age -> Yes, then 
