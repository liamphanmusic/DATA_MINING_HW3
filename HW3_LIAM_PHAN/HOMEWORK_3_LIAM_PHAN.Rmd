...
# Plotting Tree
prp(CT_Tree,type = 1, under = TRUE, split.font = 1, varlen = -10,box.col=ifelse(CT_Tree$frame$var == "<leaf>", 'gray', 'white'))
...
Prediction_1_Car <- data.frame("Age_08_04"=77,"KM"=117000, "Fuel_Type"="Petrol","HP"=110,"Automatic"=0,"Doors"=5,"Quarterly_Tax"=100,"Guarantee_Period"=3, "Airco"=1, "Automatic"=0, "CD_Player"=0, "Powered_Windows"=0, "Sport_Model"=0, "Tow_Bar"=1)
