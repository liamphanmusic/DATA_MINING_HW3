...
>  The closest Cp to P+1 is the last one (16th value) which is 16, close to 17 = p+1 = 16+1.
...
> Depending if we decided to drop the variable Mfr_Guarante after the Exhaustive Search and Popular Subset Selection Algorithms, we should have those 3-4 most important variable for predicting car's price: **Age**, **KM**, **Automatic_airco** and **Quarterly_Tax**.
...
car.lm.pred <- predict(Regression, Validation)
