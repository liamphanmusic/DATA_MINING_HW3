...
### Neural Network - 1 Hidden Layers with 2 Nodes 
...
nn <- neuralnet(Price ~ ., data = Train_NN_Preprocess, linear.output = T, hidden = 2)
...
### Neural Network - 1 Hidden Layers with 5 Nodes 
...
### Neural Network - 2 Hidden Layers with 5 Nodes in each
...
# Predictions with nn
Train_Prediction_nn <- predict(nn,Train_NN_Preprocess)
...
# Predictions with nn
Train_Prediction_nn <- Train_Prediction_nn*(max(Train_NN$Price)-min(Train_NN$Price))+min(Train_NN$Price)
...
RMSE_Train_Prediction_nn <- RMSE(Train_Prediction_nn,Train_NN$Price)
...
RMSE <- c(RMSE_Train_Prediction_nn,RMSE_Train_Prediction_nn_2,RMSE_Train_Prediction_nn_3)
...
> The more we add nodes and hidden layers to our neural network, less RMSE we tend to have. That would signify that our model C is fitting more and more the training set instead of the model A.
...
# Predictions with nn
Validation_Prediction_nn <- predict(nn,Test_NN_Preprocess)
...
# Predictions with nn
Validation_Prediction_nn <- Validation_Prediction_nn*(max(Test_NN$Price)-min(Test_NN$Price))+min(Test_NN$Price)

# Predictions with nn_2
Validation_Prediction_nn_2 <- Validation_Prediction_nn_2*(max(Test_NN$Price)-min(Test_NN$Price))+min(Test_NN$Price)

# Predictions with nn_3
Validation_Prediction_nn_3 <- Validation_Prediction_nn_3*(max(Test_NN$Price)-min(Test_NN$Price))+min(Test_NN$Price)

# RMSE for Validation  -------------------------------------------------------

RMSE_Validation_Prediction_1 <- RMSE(Validation_Prediction_nn, Test_NN$Price)
