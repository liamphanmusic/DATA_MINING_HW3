...
Tree_1 <- rpart(Price ~ Age_08_04+KM+Fuel_Type+HP+Automatic+Doors+Quarterly_Tax+Mfr_Guarantee+Guarantee_Period+Airco+Automatic+CD_Player+Powered_Windows+Sport_Model+Tow_Bar, data = Training_TREE,method  = "anova", cp = 0.001)

# Plotting Regression Tree
rpart.plot(Tree_1, fallen.leaves = FALSE, box.palette ="Greens", tweak = 1.2)
