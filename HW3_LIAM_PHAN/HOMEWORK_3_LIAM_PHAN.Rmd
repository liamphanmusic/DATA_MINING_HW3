...
# Predictions with nn
Prediction_nn <- predict(nn,Test_NN_Preprocess)

# Predictions with nn_2
Prediction_nn_2 <- predict(nn_2,Test_NN_Preprocess)

# Predictions with nn_3
Prediction_nn_3 <- predict(nn_3,Test_NN_Preprocess)

# Back transform to Original Scale ---------------------------

# Predictions with nn
Prediction_nn <- Prediction_nn*(max(Test_NN$Price)-min(Test_NN$Price))+min(Test_NN$Price)

# Predictions with nn_2
Prediction_nn_2 <- Prediction_nn_2*(max(Test_NN$Price)-min(Test_NN$Price))+min(Test_NN$Price)

# Predictions with nn_3
Prediction_nn_3 <- Prediction_nn_3*(max(Test_NN$Price)-min(Test_NN$Price))+min(Test_NN$Price)

# RMS -------------------------------------------------------

RMSE_Prediction_1 <- RMSE(Prediction_nn, Test_NN$Price)
RMSE_Prediction_2 <- RMSE(Prediction_nn_2, Test_NN$Price)
RMSE_Prediction_3 <- RMSE(Prediction_nn_3, Test_NN$Price)

Column_RMSE <- c(RMSE_Prediction_1,RMSE_Prediction_2,RMSE_Prediction_3)

Frame_RMSE <- as.data.frame(Column_RMSE)
